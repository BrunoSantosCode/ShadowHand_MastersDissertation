...
/*  - Adaptable average filter for joint angles          */
...
void handKeypointsCB(const human_robot_map::HandKeypoints::ConstPtr& msg)
{
    ...
    std::vector<Eigen::Vector3d> aux;

    aux.push_back(rot * point2vector(msg->keypoints[0], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[1], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[2], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[3], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[4], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[5], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[6], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[7], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[8], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[9], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[10], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[11], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[12], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[13], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[14], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[15], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[16], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[17], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[18], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[19], msg->keypoints[0]));
    aux.push_back(rot * point2vector(msg->keypoints[20], msg->keypoints[0]));

    mutex_kp.lock();
        kp_positions.insert(kp_positions.begin(), aux);
...
{
    // Init ROS node
    ros::init(argc, argv, "bio_ik_v3");
    std::cout << "\"bio_ik_v3\" ROS node started!" << std::endl;
    ros::NodeHandle nh;
    ...
    // Positions average vector first state
    ...
    // Ready 
    std::cout << "\n\033[1;32m\"bio_ik_v3\" ROS node is ready!\033[0m\n" << std::endl;
