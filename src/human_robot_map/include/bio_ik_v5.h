...
std::string path1 = "/home/user/projects/shadow_robot/base/src/human_robot_map/src/human_hand_kp_bio_ik_video.txt";
std::ofstream file_human(path1);
std::string path2 = "/home/user/projects/shadow_robot/base/src/human_robot_map/src/shadow_hand_kp_bio_ik_video.txt";
...
void plotKeypointsRVIZ(std::vector<Eigen::Vector3d> kp, bool shadow)
{
    ...
    marker_array.markers.resize(28);

    if (shadow == false)
    {
        for (int i=0; i<kp.size(); i++)
            kp[i].z() = kp[i].z() + 34.0/1000; // rh_palm -> wr_wrist
    }

    // Init dot markers [keypoints]
    for (int i = 0; i < 21+1; i++)
    {
        marker_array.markers[i].header.frame_id = "rh_wrist";
        ...
        if (i<21) {
            ...
            marker_array.markers[i].pose.position.x = 0.0;
            marker_array.markers[i].pose.position.y = 0.0;
    ...
    // Wrist
    marker_array.markers[22].points.resize(2);
    ...
    marker_array.markers[22].points[1].x = kp[21].x();
    marker_array.markers[22].points[1].y = kp[21].y();
    marker_array.markers[22].points[1].z = kp[21].z();
    ...
    marker_array.markers[23].points[1].x = kp[1].x();
    marker_array.markers[23].points[1].y = kp[1].y();
    marker_array.markers[23].points[1].z = kp[1].z();
    marker_array.markers[23].points[2].x = kp[2].x();
    marker_array.markers[23].points[2].y = kp[2].y();
    marker_array.markers[23].points[2].z = kp[2].z();
    marker_array.markers[23].points[3].x = kp[3].x();
    marker_array.markers[23].points[3].y = kp[3].y();
    marker_array.markers[23].points[3].z = kp[3].z();
    marker_array.markers[23].points[4].x = kp[4].x();
    marker_array.markers[23].points[4].y = kp[4].y();
    marker_array.markers[23].points[4].z = kp[4].z();
    ...
    marker_array.markers[24].points[1].x = kp[5].x();
    marker_array.markers[24].points[1].y = kp[5].y();
    marker_array.markers[24].points[1].z = kp[5].z();
    marker_array.markers[24].points[2].x = kp[6].x();
    marker_array.markers[24].points[2].y = kp[6].y();
    marker_array.markers[24].points[2].z = kp[6].z();
    marker_array.markers[24].points[3].x = kp[7].x();
    marker_array.markers[24].points[3].y = kp[7].y();
    marker_array.markers[24].points[3].z = kp[7].z();
    marker_array.markers[24].points[4].x = kp[8].x();
    marker_array.markers[24].points[4].y = kp[8].y();
    marker_array.markers[24].points[4].z = kp[8].z();
    ...
    marker_array.markers[25].points[1].x = kp[9].x();
    marker_array.markers[25].points[1].y = kp[9].y();
    marker_array.markers[25].points[1].z = kp[9].z();
    marker_array.markers[25].points[2].x = kp[10].x();
    marker_array.markers[25].points[2].y = kp[10].y();
    marker_array.markers[25].points[2].z = kp[10].z();
    marker_array.markers[25].points[3].x = kp[11].x();
    marker_array.markers[25].points[3].y = kp[11].y();
    marker_array.markers[25].points[3].z = kp[11].z();
    marker_array.markers[25].points[4].x = kp[12].x();
    marker_array.markers[25].points[4].y = kp[12].y();
    marker_array.markers[25].points[4].z = kp[12].z();
    ...
    marker_array.markers[26].points[1].x = kp[13].x();
    marker_array.markers[26].points[1].y = kp[13].y();
    marker_array.markers[26].points[1].z = kp[13].z();
    marker_array.markers[26].points[2].x = kp[14].x();
    marker_array.markers[26].points[2].y = kp[14].y();
    marker_array.markers[26].points[2].z = kp[14].z();
    marker_array.markers[26].points[3].x = kp[15].x();
    marker_array.markers[26].points[3].y = kp[15].y();
    marker_array.markers[26].points[3].z = kp[15].z();
    marker_array.markers[26].points[4].x = kp[16].x();
    marker_array.markers[26].points[4].y = kp[16].y();
    marker_array.markers[26].points[4].z = kp[16].z();

    // Littlefinger
    marker_array.markers[27].points.resize(5);
    marker_array.markers[27].points[0].x = kp[0].x();
    marker_array.markers[27].points[0].y = kp[0].y();
    marker_array.markers[27].points[0].z = kp[0].z();
    marker_array.markers[27].points[1].x = kp[17].x();
    marker_array.markers[27].points[1].y = kp[17].y();
    marker_array.markers[27].points[1].z = kp[17].z();
    marker_array.markers[27].points[2].x = kp[18].x();
    marker_array.markers[27].points[2].y = kp[18].y();
    marker_array.markers[27].points[2].z = kp[18].z();
    marker_array.markers[27].points[3].x = kp[19].x();
    marker_array.markers[27].points[3].y = kp[19].y();
    marker_array.markers[27].points[3].z = kp[19].z();
    marker_array.markers[27].points[4].x = kp[20].x();
    marker_array.markers[27].points[4].y = kp[20].y();
    marker_array.markers[27].points[4].z = kp[20].z();
